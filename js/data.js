/* ============================================================
   ...
   🗂️  الألبومات: مصفوفة albums تربط صور الذكريات في ألبومات
       (photos = أرقام الذكريات بالترتيب من 1 إلى 49)
   ============================================================ */
...
/* ===== ألبومات الصور =====
   photos: قائمة أرقام الصور (من 1 إلى 49) التي تنتمي لهذا الألبوم */
const albums = [
  {
    id: 'beginning',
    name: 'بدايتنا',
    emoji: '🌹',
    desc: 'أول رسائلنا وأول صورنا… حين بدأ كل شيء',
    photos: [1, 2, 3, 14, 15, 16, 17],
  },
  {
    id: 'april22',
    name: 'ليالي أبريل',
    emoji: '🌙',
    desc: 'سهرات أبريل الدافئة… ضحكٌ وكلامٌ حتى الصباح',
    photos: [7, 8, 9, 10, 11, 12],
  },
  {
    id: 'movie',
    name: 'سهرة أفلامنا',
    emoji: '🎬',
    desc: 'أفلام شاهدناها معاً… فصارت أجمل ذكرياتنا',
    photos: [18, 27, 28, 29, 30, 31, 32, 33, 34],
  },
  {
    id: 'ourday',
    name: 'يومنا الكبير',
    emoji: '💖',
    desc: '25 أبريل — يوم كامل من اللحظات الحقيقية',
    photos: [19, 20, 21, 22, 23, 24, 25, 26, 35, 36, 37, 38, 39, 40, 41],
  },
  {
    id: 'snap',
    name: 'لحظات سناب',
    emoji: '💫',
    desc: 'لقطات عابرة… بقيت في القلب إلى الأبد',
    photos: [4, 5, 6, 13, 42, 43, 44, 45, 46, 47, 48, 49],
  },
];
